...
public class SearchForProductJPanel extends javax.swing.JPanel {
   ...
   Supplier supplier;
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        ...
        String searchQuery = idField.getText();
        if(searchQuery.isEmpty()) {
            JOptionPane.showMessageDialog(this, "please Enter something in the search box");
            return;
        }
        for(Product product: supplier.getProductCatalog().getProductCatalog()) {
            if(String.valueOf(product.getId()).equals(searchQuery)){
                ViewProductDetailJPanel viewProductDetailJPanel = new ViewProductDetailJPanel(workArea, product);
                workArea.add("product",viewProductDetailJPanel);
