...
public class ManageProductCatalogJPanel extends javax.swing.JPanel {
    ...
    private void btnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewActionPerformed
        ...
        Product product =(Product) tblProducts.getValueAt(tblProducts.getSelectedRow(),0);
        ViewProductDetailJPanel viewProductDetailJPanel = new ViewProductDetailJPanel(workArea, product);
        workArea.add("viewProductDetails",viewProductDetailJPanel);
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        if(supplier.getProductCatalog().getProductCatalog().size() ==0 ) {
            JOptionPane.showMessageDialog(this, "No products to search");
            return;
        }
        SearchForProductJPanel searchForProductJPanel = new SearchForProductJPanel(workArea, supplier);
        workArea.add("searchForProductJPanel",searchForProductJPanel);
        CardLayout layout = (CardLayout) workArea.getLayout();
        layout.next(workArea);
