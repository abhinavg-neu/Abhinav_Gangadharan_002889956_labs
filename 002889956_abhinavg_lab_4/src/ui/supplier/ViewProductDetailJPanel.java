...
public class ViewProductDetailJPanel extends javax.swing.JPanel {
    ...
    private void backAction() {
        ...
        if(componentArray[componentArray.length - 1].getClass() == ManageProductCatalogJPanel.class)
...
//        System.out.println();
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        try{
            ...
            JOptionPane.showMessageDialog(this, "Please enter a number in the price text box");
            return;
        }
...
//         ArrayList<Feature> featureList = new ArrayList<>();
       for (int i = 0;i<model.getRowCount();i++) {
           Feature currFeature = product.getFeatures().get(i);
           currFeature.setName(tblFeatures.getValueAt(i, 0).toString());
           currFeature.setValue(tblFeatures.getValueAt(i, 1));
       }
...
//        model.setRowCount(++rowCount);
        ...
        feature.setValue("Value goes here");
    ...
    private void btnRemoveFeatureActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveFeatureActionPerformed
        ...
        if(selectedRow <0) {
            JOptionPane.showMessageDialog(this, "Please select a row from the feature table");
            return;
        } 
